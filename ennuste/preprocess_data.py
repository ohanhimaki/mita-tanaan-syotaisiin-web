...
#example:
# date,dayData,votes,nimi
# 20221114,"SALAATTIPÖYTÄ <br>PORKKANASOSEKEITTOA(G,L) <br>*********** <br>MAKKARAPIHVEJÄ(G,L) <br>JAUHELIHAKASTIKETTA(G,L) <br>SULJEMME TÄNÄÄN KLO 14.00!",,PATA-KAKKONEN
...
total_votes.to_csv('model_TotalVotes.csv', index=False)
...
df.to_csv('model_MostCommonWords.csv', index=False)
